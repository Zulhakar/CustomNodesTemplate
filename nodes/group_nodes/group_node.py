...
from ...nodes.basic_nodes import ObmNode
from ...core.helper import get_socket_index, _checker


class GroupNodeObm(ObmNode, bpy.types.NodeCustomGroup):
    bl_label = "Group"
    bl_icon = 'NODETREE'
    ...
    all_trees: bpy.props.PointerProperty(
        name="Group",
        type=bpy.types.NodeTree,
        poll=lambda self, tree: (tree.bl_idname == OB_TREE_TYPE and _checker(self, tree)),
